...
import (
	...
	"zntr.io/vaultify/cubbyhole"
	"zntr.io/vaultify/kv"
	"zntr.io/vaultify/transit"
)
...
func (c *client) KV(mountPath string, opts ...kv.Option) (kv.Service, error) {
	return kv.New(c.Client, mountPath, opts...)
}
